export function createProfileController({
  ...
  function applyServerProfile(profile){
    ...
    for(const key of ["cargoHold","shipCargo","skillRanks","skillLevels","completedPortals","portalPieces","refineryLevels","refineryModules","refineryUpgradeJobs","refineryProductionDisabled","questProgress","questFailProgress","completedQuestClaims"]){
