...
import { createCombatSceneRenderer } from "./render/combatScene.js?v=craft-map-labels-1";
...
import { createLevelUpEffectSystem } from "./systems/levelUpEffects.js?v=craft-map-labels-1";
...
import { createCombatStatusEffectSystem } from "./systems/combatStatusEffects.js?v=craft-map-labels-1";
...
import { createCombatPanels } from "./ui/combatPanels.js?v=craft-map-labels-1";
...
export function createCombatGame({renderAll, showToast}){
  ...
  installCombatInputHandlers({
    ...
    selectCraftTabPage:panels.selectCraftTabPage,
