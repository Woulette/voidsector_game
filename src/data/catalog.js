export { ships } from "./ships.js?v=craft-balance-2";
export { ammoTypes, droneCatalog, droneFormations, equipment } from "./equipment.js?v=craft-balance-2";
...
export const defaultState = {
  ...
  betaRewardState:{claimedDays:[], lastClaimDate:"", randomShipRewards:{}},
  betaPackPurchases:[],
